...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	 ...
	 * http.authorizeRequests().antMatchers("/products/form").hasRole("ADMIN").
	 * antMatchers("/shopping/**").permitAll() .antMatchers(HttpMethod.POST,
	 * "/products").hasRole("ADMIN").antMatchers("/products/**").permitAll()
