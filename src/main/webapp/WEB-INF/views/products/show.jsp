...
<body class="product">
	...
	<nav class="categories-nav">
		<ul class="container">
			...
			<li class="category"><a href="/collections/livros-de-agile"><fmt:message	key="navigation.category.agile"/></a>
			</li>
			<li class="category"><a href="/collections/livros-de-front-end"><fmt:message	key="navigation.category.front"/>	
					End</a></li>
			...
			<li class="category"><a
				href="/collections/livros-desenvolvimento-web"><fmt:message	key="navigation.category.web"/></a></li>
	...
	<article id="${product.title}" itemscope
		itemtype="http://schema.org/Book">category
